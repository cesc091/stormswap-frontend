...
const PageHeader: React.FC<PageHeaderProps> = ({ icon, icon1, wordmark, subtitle, title, isBfx }) => {
  return (
    <Container size="sm">
      <StyledPageHeader>
        {!title ? (
          <Title>
            ...
            <TitleText>
              <img style={{ marginLeft: '4px' }} src={wordmark} alt="StormSwap" />
            </TitleText>
          </Title>
        ) : (
          <FarmTitle>
