...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    // backgrounds / greys
    bg1: darkMode ? '#111' : '#111',
    bg2: darkMode ? '#14151a' : '#14151a',
    bg3: darkMode ? '#141515' : '#141515',
    ...
    //primary colors
    primary1: darkMode ? '#F0B90B' : '#F0B90B',
    primary2: darkMode ? '#3680E7' : '#3680E7',
    primary3: darkMode ? '#4D8FEA' : '#4D8FEA',
    primary4: darkMode ? '#c99b06' : '#c99b06',
    primary5: darkMode ? '#F0B90B' : '#F0B90B',
...
body {
  ...
  background-image: ${({ theme }) =>
    `radial-gradient(50% 50% at 50% 50%, ${transparentize(0.9, theme.bg4)} 0%, ${transparentize(1, theme.bg1)} 100%)`};
}
`
