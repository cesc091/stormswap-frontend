...
import ThunderCloudAbi from './abi/ThunderCloud.json'
import StormAbi from './abi/StormToken.json'
import UNIV2PairAbi from './abi/uni_v2_lp.json'
import WETHAbi from './abi/weth.json'
import BifrostAbi from './abi/Bifrost.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.sushi = new this.web3.eth.Contract(StormAbi.abi)
    this.masterChef = new this.web3.eth.Contract(ThunderCloudAbi.abi)
    this.weth = new this.web3.eth.Contract(WETHAbi)
    this.bifrost = new this.web3.eth.Contract(BifrostAbi.abi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.bifrost, contractAddresses.bifrost[networkId])
  ...
  setDefaultAccount(account) {
    ...
    this.bifrost.options.from = account
  }
